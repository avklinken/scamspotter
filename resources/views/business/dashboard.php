...
<div class="business-page">
    ...
    <div class="business-metric-grid">
        ...
        <div class="business-metric"><span>Uitleg nuttig</span><strong><?= e($metrics['feedback_useful'] ?? 0) ?></strong><small>feedback · 30 dagen</small></div>
        <div class="business-metric"><span>Uitleg verbeteren</span><strong><?= e($metrics['feedback_not_useful'] ?? 0) ?></strong><small>feedback · 30 dagen</small></div>
        <div class="business-metric"><span>Plan</span><strong><?= e($plan['plan']['label'] ?? 'Pilot') ?></strong><small><?= e($planUsage['checks_month'] ?? 0) ?> / <?= e($planUsage['limit'] ?? 0) ?> checks deze maand</small></div>
    </div>
    <section class="business-card business-usage-card"><div class="business-card-header"><div><p class="eyebrow">Kostenbewust piloteren</p><h2>AI-verbruik · 30 dagen</h2></div><span class="form-help">Geen schijnprecisie in euro’s; tokens blijven controleerbaar.</span></div><div class="business-usage-grid"><div><strong><?= e($aiUsage['runs'] ?? 0) ?></strong><span>AI-analyses</span></div><div><strong><?= e(number_format((int) ($aiUsage['input_tokens'] ?? 0), 0, ',', '.')) ?></strong><span>inputtokens</span></div><div><strong><?= e(number_format((int) ($aiUsage['output_tokens'] ?? 0), 0, ',', '.')) ?></strong><span>outputtokens</span></div></div><p class="business-note">Sterke lokale matches vragen standaard geen aanvullende Business-AI-analyse. Gebruik deze cijfers samen met je OpenAI-factuur voor echte kostencontrole.</p></section>
